...
#define BLUE_LED_IO_MUX     PERIPHS_IO_MUX_MTCK_U
#define BLUE_LED_IO_NUM     13
#define BLUE_LED_IO_FUNC    FUNC_GPIO13

#define RED_LED_IO_MUX     PERIPHS_IO_MUX_MTDI_U
#define RED_LED_IO_NUM     12
#define RED_LED_IO_FUNC    FUNC_GPIO12

#define GREEN_LED_IO_MUX     GPIO_13_ADDR
#define GREEN_LED_IO_NUM     13
#define GREEN_LED_IO_FUNC    FUNC_GPIO13
